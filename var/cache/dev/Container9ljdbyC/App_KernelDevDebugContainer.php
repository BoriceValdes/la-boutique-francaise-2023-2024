...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Account\\WishlistController' => 'getWishlistControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UG3eVn4mVH', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fM3Bsx4i91', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JeS3NlLWcH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-rn5bxAPmg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\la-boutique-francaise-2023-2024\\src\\Entity'], true)), 'App\\Entity');
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [#[\Closure(name: 'App\\EventSubscriber\\LoginSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\LoginSubscriber'] ?? $container->load('getLoginSubscriberService')), 'onLogin'], 0);
    ...
    protected static function getEntityFactoryService($container)
    {
        ...
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\EntityFactory'] = new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory(new \EasyCorp\Bundle\EasyAdminBundle\Factory\FieldFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $b, new RewindableGenerator(function () use ($container) {
            ...
            yield 13 => ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Field\\Configurator\\ImageConfigurator'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Field\Configurator\ImageConfigurator('C:\\la-boutique-francaise-2023-2024'));
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gZ4UzYWquG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('uOZo+veos0', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UZeJAabJWu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6C-K3NNm1I', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eqexN-4BNT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xaDB-fZUEp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\la-boutique-francaise-2023-2024', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'fr', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ar.php'], 'az' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.bg.php'], 'bs' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ca.php'], 'cs' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.cs.php'], 'cy' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.da.php'], 'de' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.de.php'], 'el' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.el.php'], 'en' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.en.php'], 'es' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.es.php'], 'et' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.eu.php'], 'fa' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fa.php'], 'fi' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fi.php'], 'fr' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fr.php'], 'gl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.gl.php'], 'he' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.he.php'], 'hr' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hr.php'], 'hu' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hu.php'], 'hy' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hy.php'], 'id' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.id.php'], 'it' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.it.php'], 'ja' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.lb.php'], 'lt' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.lt.php'], 'lv' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.mk.php'], 'mn' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.nl.php'], 'nn' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.no.php'], 'pl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pl.php'], 'pt' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pt.php'], 'pt_BR' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pt_BR.php'], 'ro' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ro.php'], 'ru' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ru.php'], 'sk' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sk.php'], 'sl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sl.php'], 'sq' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sv.php'], 'th' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.tr.php'], 'uk' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.uk.php'], 'ur' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.zh_CN.php'], 'zh_TW' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf'], 'sr_RS' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sr_RS.php']], 'scanned_directories' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\framework-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\debug-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\twig\\extra-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\monolog-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\maker-bundle\\src/translations', 'C:\\la-boutique-francaise-2023-2024/translations'], 'cache_vary' => ['scanned_directories' => ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\validator/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-core/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\framework-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\debug-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\twig\\extra-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\monolog-bundle/translations', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\maker-bundle\\src/translations', 'translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\la-boutique-francaise-2023-2024');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\la-boutique-francaise-2023-2024/templates/bundles/TwigBundle', 'Twig');
        $a->addPath('C:\\la-boutique-francaise-2023-2024/templates/bundles/TwigBundle', '!Twig');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/views', 'EasyAdmin');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/views', '!EasyAdmin');
        $a->addPath('C:\\la-boutique-francaise-2023-2024/templates');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($f, 'C:\\la-boutique-francaise-2023-2024', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\la-boutique-francaise-2023-2024',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'EasyAdminBundle' => [
                    'path' => 'C:\\la-boutique-francaise-2023-2024\\vendor\\easycorp\\easyadmin-bundle\\src',
            ...
            'translator.default_path' => 'C:\\la-boutique-francaise-2023-2024/translations',
            ...
            'twig.default_path' => 'C:\\la-boutique-francaise-2023-2024/templates',
