...
class getMakeCrudControllerCommandService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->services['EasyCorp\\Bundle\\EasyAdminBundle\\Command\\MakeCrudControllerCommand'] = $instance = new \EasyCorp\Bundle\EasyAdminBundle\Command\MakeCrudControllerCommand('C:\\la-boutique-francaise-2023-2024', ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Maker\\ClassMaker'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Maker\ClassMaker(($container->services['kernel'] ?? $container->get('kernel', 1)), 'C:\\la-boutique-francaise-2023-2024')), ($container->services['doctrine'] ?? self::getDoctrineService($container)));
