...
class getTwig_TemplateCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        ]))->withContext('twig.template_cache_warmer', $container), new \Symfony\Bundle\TwigBundle\TemplateIterator(($container->services['kernel'] ?? $container->get('kernel', 1)), ['C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'C:\\la-boutique-francaise-2023-2024\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'C:\\la-boutique-francaise-2023-2024/templates', []));
    }
}
